...
![image](https://github.com/user-attachments/assets/d8df7c6b-ef17-46e1-b6cb-8ad20a668965)
...
![image](https://github.com/user-attachments/assets/f7a5b0bb-4034-4f73-a23a-d81516321ea6)


`Fork` 가 완료되면 자신의 레포지토리(오른쪽 위 상단의 프로필 이미지 클릭후, Your repositories)에 가시면 본 github 으로부터 Fork 된 repository 가 생성되어 있습니다. 

![image](https://github.com/user-attachments/assets/4193cd29-cf52-4ebf-bf05-df77f9f1b957)


해당 레포지토리를 클릭하여 접속하시고, 초록색 버튼인 `Clone or download`를 눌러서 하단의 링크를 복사 혹은 기억해둡니다.

![image](https://github.com/user-attachments/assets/1f69bb85-159c-45c9-bde6-7c0bc95049c0)
...
![image](https://github.com/user-attachments/assets/0975298d-6cd3-48d0-97cc-be49aedf21c4)


이제 인터넷 창에 제일 처음이 도커실행시 주어진 IP 주소를 이용해 `[IP주소]:8888` 를 입력합니다. 그러면 아래 화면이 등장합니다.

![image](https://github.com/user-attachments/assets/06081186-1fa1-4368-8008-795234af63ea)
